...
public class GetOperationMethodTest {
	...
	private static final int N_OPERATIONS = 1;
	private static final int N_TOTALVALUES = 100;
	...
	@Test
	public void GetNumberOfOperations() throws SibsException {
		assertEquals(N_OPERATIONS, this.sibs.GetNumberOfOperations());
	}
	
	@Test
	public void GetValueOfOperations() throws SibsException {
		assertEquals(N_TOTALVALUES, this.sibs.GetValueOfOperations());
	}
